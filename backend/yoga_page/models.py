...
class Image(models.Model):
    ...
    image = models.ImageField(blank=False, upload_to="yoga_page") # save path: MEDIA_ROOT/yoga_page
    
    def __str__(self):
        return self.branch.name

class Video(models.Model):
    branch = models.ForeignKey(Branch, related_name='videos', on_delete=models.CASCADE)
